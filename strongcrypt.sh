#!/bin/sh
#
# strongcrypt.sh -- Automatic folder encryption and decryption
#
...
PROGRESS BAR EXPLANATION:
  You will not see a progress bar. Because this script adheres strictly to 
  POSIX standards to ensure maximum portability across all Unix systems, it 
  relies on standard input/output pipes. Unix pipes process data silently in 
  the background. If the script appears "frozen" after you enter your password, 
  it is simply working hard to encrypt/decrypt your data.
